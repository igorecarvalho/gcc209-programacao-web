                ...
                <v-col cols="12" style="padding: 20px">
                    ...
                    <v-row>
                        ...
                        <v-col
                            ...
                            <v-text-field
                                v-model="contato.logradouroContato"
                                :value="contato.logradouroContato"
                                label="Logradouro"
                            ></v-text-field>
                        ...
                        <v-col
                            ...
                            <v-text-field
                                v-model="contato.bairroContato"
                                :value="contato.bairroContato"
                                label="Bairro"
                            ></v-text-field>
                    ...
                    <v-row>
                        ...
                        <v-col
                            ...
                            <v-text-field
                                v-model="contato.localidadeContato"
                                :value="contato.localidadeContato"
                                label="Cidade"
                            ></v-text-field>
                        ...
                        <v-col
                            ...
                            <v-text-field
                                v-model="contato.ufContato"
                                :value="contato.ufContato"
                                label="UF"
                            ></v-text-field>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            attEndereco(){
                console.log(this.contato.cepContato)
                CepServices.getEndereco(this.contato.cepContato)
                    .then(resposta => {
                        this.contato.logradouroContato = resposta.data.logradouro
                        this.contato.bairroContato = resposta.data.bairro
                        this.contato.localidadeContato = resposta.data.localidade
                        this.contato.ufContato = resposta.data.uf
